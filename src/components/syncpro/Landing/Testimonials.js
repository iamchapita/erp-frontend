...
export default function Testimonios() {
    return (
        <>
            <div>
                <h2 className="text-2xl leading-6 text-gray-800 text-center px-4">Testimonios</h2>
                <h1 className="lg:text-5xl md:text-4xl text-2xl font-semibold px-4 leading-10 text-gray-800 mt-6 text-center">Lo que dicen nuestros clientes</h1>
                <div className="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 xl:px-20 px-10 py-20 gap-6">
                    <div>
                        <div className="group w-full bg-white relative flex flex-col items-center hover:bg-custom-300 cursor-pointer shadow-md md:p-12 p-6">
                            <div className="text-black group- flex flex-col items-center">
                                ...
                                <p className="xl:w-80 text-base leading-normal text-center mt-4">
                                    Desde que implementamos SyncPro en nuestra empresa, la gestión de inventario se ha vuelto mucho más eficiente. Ahora podemos realizar un seguimiento preciso de nuestros productos y optimizar nuestros pedidos. ¡Una herramienta imprescindible para cualquier negocio!                                </p>
                            </div>
                        ...
                        <div className="flex flex-col items-center justify-center mt-10">
                            ...
                            <p className="text-base leading-4 text-center text-black">Emprendedora</p>
                        </div>
                    </div>
                    <div>
                        <div className="group w-full bg-white relative flex flex-col items-center hover:bg-custom-300 cursor-pointer shadow-md md:p-12 p-6">
                            <div className="text-black group- flex flex-col items-center">
                                ...
                                <p className="xl:w-80 text-base leading-normal text-center mt-4">
                                    SyncPro ha transformado la forma en que manejamos nuestros procesos internos. La integración perfecta de módulos como ventas, compras y finanzas ha permitido una comunicación fluida entre departamentos. Estamos ahorrando tiempo y recursos de manera significativa.
                                </p>
                            </div>
                            <div className="text-white group-hover:text-indigo-700 absolute bottom-0 -mb-6">
                                <svg width={34} height={28} viewBox="0 0 34 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex flex-col items-center justify-center mt-10">
                            ...
                            <p className="text-base leading-4 text-center text-black">Director de operaciones</p>
                        </div>
                    </div>
                    <div>
                        <div className="group w-full bg-white relative flex flex-col items-center hover:bg-custom-300 cursor-pointer shadow-md md:p-12 p-6">
                            <div className="text-black group- flex flex-col items-center">
                                ...
                                <p className="xl:w-80 text-base leading-normal text-center mt-4">
                                    Como contadora, valoro enormemente la precisión y facilidad que SyncPro aporta a nuestras operaciones contables. Generar informes financieros y balances ahora es más rápido y preciso, lo que nos ayuda a tomar decisiones informadas para el crecimiento de la empresa.
                                </p>
                            </div>
                            <div className="text-white group-hover:text-indigo-700 absolute bottom-0 -mb-6">
                                <svg width={34} height={28} viewBox="0 0 34 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex flex-col items-center justify-center mt-10">
                            ...
                            <p className="text-base leading-4 text-center text-black">Contadora</p>
                        </div>
                    </div>
                </div>
            </div>
